...
function Badge({ children, variant }) {
  ...
  return (
    <span className={`${baseClasses} ${variants[variant] || variants.outline}`}>
      {children}
    </span>
  );
}
...
export default function BookingHistory() {
  ...
  const [createRating, { isLoading: isRatingLoading }] =
  ...
  const [sendRefundRequest, { isLoading: isRefunding }] =
    useSendRefundRequestMutation();
  ...
  const handleRefundRequest = async () => {
    if (!refundBookingId || !refundReason || proofOfPaymentFiles.length === 0) {
      toast({
        ...
        description:
          "Please provide all required information for the refund request.",
        variant: "destructive",
      });
      return;
    }
          ...
          {isLoadingDetail ? (
            ...
            <>
              ...
              <div className="grid gap-6 py-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            {format(
                              new Date(detail.preferDateStart),
                              "MMMM d, yyyy"
                            )}
                          </p>
                        </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            {detail.cleaningServiceDuration} hour(s)
                          </p>
                        </div>
                      </div>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2 mt-1">
                            {detail.additionalServiceName.length > 0 ? (
                              detail.additionalServiceName.map(
                                (service, index) => (
                                  <span
                                    key={index}
                ...
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-lg">Booking proof</CardTitle>
                  </CardHeader>
                  <CardContent className="grid gap-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {bookingDetail?.data?.proof ? (
                        <div className="text-sm font-medium flex items-center gap-1">
                          <img src={bookingDetail?.data?.proof} alt="" className="w-full h-full"/>
                        </div>
                      ) : (
                        <div className="text-sm font-medium flex items-center gap-1">
                          No proof uploaded!
    ...
    <div className="space-y-8">
                          ...
                          <div className="flex-1 space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div className="flex items-center gap-2 text-muted-foreground">
                                ...
                                <span>
                                  {format(
                                    new Date(booking.preferDateStart),
                                    "MMMM d, yyyy"
                                  )}
                                </span>
                              </div>
                              ...
                              <div className="flex items-center gap-2 text-muted-foreground">
                                ...
                                <span>
                                  {booking.cleaningServiceDuration} hour(s)
                                </span>
                              </div>
                              <div className="flex items-center gap-2 text-muted-foreground">
                            ...
                            <div className="flex flex-col gap-2">
                              ...
                              {booking.status === "OnGoing" &&
                                booking.isCancelable && (
                                  <Button
                                    onClick={(e) =>
                                      openCancelModal(e, booking.bookingId)
                                    }
                                    variant="destructive"
                              ...
                              {booking.status === "Completed" && (
                                <Button
                                  onClick={(e) =>
                                    openRefundModal(e, booking.bookingId)
                                  }
                                  variant="outline"
          ...
          {bookingHistory?.data?.totalPages > 1 && (
            <div className="flex justify-center mt-8">
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  {Array.from(
                    { length: bookingHistory.data.totalPages },
                    (_, i) => (
                      <Button
                        key={i + 1}
      ...
      <Dialog open={isCancelModalOpen} onOpenChange={setIsCancelModalOpen}>
        <DialogContent className="sm:max-w-[425px]">
          ...
          <div className="py-4">
            <p className="text-sm text-muted-foreground">
              Canceling a booking may be subject to your service provider's
              cancellation policy. You may receive a partial refund depending on
              how close the cancellation is to the scheduled service time.
            </p>
          </div>
          <div className="flex justify-end gap-4">
            <Button
      ...
      <Dialog open={isRefundModalOpen} onOpenChange={setIsRefundModalOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Please provide the necessary information to process your refund
              request.
            </DialogDescription>
          </DialogHeader>
          <div className="py-4 space-y-4">
            ...
            <div className="bg-amber-50 p-3 rounded-md border border-amber-200">
              <p className="text-sm text-amber-800">
                <strong>Note:</strong> Refund requests are subject to review.
          ...
          <div className="flex justify-end gap-4">
            ...
            <Button
              ...
              disabled={
                isRefunding || !refundReason || proofOfPaymentFiles.length === 0
              }
