...
export function RevenueChart() {
  ...
  const [endDate, setEndDate] = useState(new Date());
    ...
    const queryParams = {
      dayRevenue: chartConfig.type === "day",
      weekRevenue: chartConfig.type === "week",
      yearRevenue: chartConfig.type === "year",
      yearsRevenue: chartConfig.type === "years",
    ...
    const { data: revenueChartData, isLoading: isChartLoading } = useGetRevenueHousekeeperChartDataQuery(queryParams);
