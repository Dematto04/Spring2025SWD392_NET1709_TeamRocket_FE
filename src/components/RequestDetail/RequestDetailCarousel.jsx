...
function RequestDetailCarousel({ images, categoryPictureUrl }) {
  ...
  // Use category picture as fallback if no images are provided
  const displayImages = images.length > 0 ? images : [categoryPictureUrl];
...
export default RequestDetailCarousel;